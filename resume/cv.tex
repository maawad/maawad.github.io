...
\textbf{Part-Time Teaching Assistant} \hfill {July 2014 to October 2016}
\begin{innerlist}
...
Random Packing." \emph{SGP 2016}. June 2016.
    ...
    \item M. S. Ebeida, S. A. Mitchell, \textbf{M. A Awad}, C. Park, L. P. Swiler, D. Manocha,
L.-Y. Wei.  ``Spoke Darts for Efficient High Dimensional Blue Noise Sampling." \emph{arXiv preprint arXiv:1408.1118}. August 2014.
...
\begin{innerlist}
    \item Programming: C++, QT (GUI Programming), OpenGL, CUDA C/C++ , FORTRAN.
    \item Applications: AutoCAD, Rhinoceros, Paraview, Maxsurf ship modeling and analysis
package, Robot Structural analysis, LATEX, MATLAB (linear algebra), Microsoft Office,
PostScript, and other common packages for Windows.
